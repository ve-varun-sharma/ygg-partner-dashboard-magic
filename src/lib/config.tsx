...
export const siteConfig = {
  name: "Yield Guild Games Partner Dashboard",
  description: "Create & manage quests, guilds, and more on-chain.",
  cta: "Get Started",
  ...
  hero: {
    ...
    description:
      "Launch Quests & Grow with YGG: Your Partner Dashboard is Here!",
    cta: "Get Started",
    ctaDescription: "Available for all EVM Chains!",
  },
  features: [
    {
    ...
    },
    {
      ...
      description:
        "Go from signup to launch in record time with our standardized process.",
